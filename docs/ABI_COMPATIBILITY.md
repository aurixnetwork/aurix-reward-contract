...
Mainnet readiness does not change the ABI. `npm run validate:baseline` compares the exact frozen Solidity/interface/ABI hashes, compiled ABI, and compiler settings and fails closed on drift.
